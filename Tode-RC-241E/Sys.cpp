...
Sys::Sys():
  ...
  // Initialize RF Radio
    ...
    RF = new E32Radio(RFPINS);      // Checks E32 RF-Settings in Constructor
  #elif RADIO==E220_400T30D
    RF = new E220Radio(RFPINS);     // Checks E220 RF-Settings in Constructor
  #elif RADIO==E22_400T33D
    RF = new E22Radio(RFPINS);     // Checks E22 RF-Settings in Constructor
  #else
...
void Sys::EnterSetupMenu() {                                    DBENTERL(("Sys::EnterSetupMenu"))
  ...
  RadioSettings->Add(new RadioAirSpeed());
