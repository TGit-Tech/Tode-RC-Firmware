...
void setup() {
  ...
  if ( SerialUse==USBSERUSE_RFPC ) {
    if ( System->RF!=0 ) { 
      ...
      System->RF->Mode(E32_SLEEPMODE);
      #pragma message("RADIO==E32_433T30D")
    #elif RADIO==E220_400T30D
      System->RF->Mode(E220_SLEEPMODE);
      #pragma message("RADIO==E220_400T30D")
    #elif RADIO==E22_400T33D
      System->RF->Mode(E22_SLEEPMODE);
      #pragma message("RADIO==E22_400T33D")
    #else
      #error Setup() RADIO in config.h not found.
    #endif
    }
