...
namespace ButtonISR {
  ...
  ISR(PCINT0_vect) {
	...
	if (     (PINB&0b11110000)==0b01110000) { Current_Button = NAVKEYSET; }
	else if ((PINB&0b11110000)==0b10110000) { Current_Button = NAVKEYOKAY; }
	else if ((PINB&0b11110000)==0b11010000) { Current_Button = NAVKEYRIGHT; }
	else if ((PINB&0b11110000)==0b11100000) { Current_Button = NAVKEYUP; }
	//Serial.print("Current_Button=");Serial.println(Current_Button,HEX);
	//PORT PINB = 110_1101 UP
	//PORT PINB = 101_1101 RIGHT
	//PORT PINB = 011_1101 OK
	ButtonBuffer = Current_Button;
	sei();
  }
