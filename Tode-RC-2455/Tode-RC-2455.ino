 ...
 *            When an unknown Radio triggers Tx communications ends up in an endless loop (Fix This)
 * @author    TGIT-TECH   WIP 2455
 *            TGIT-TECH   Added 0x53 on E32433T30D [B1] list and fixed FEC-ON being disabled                  242I
