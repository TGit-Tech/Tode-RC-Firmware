...
class OnOff : public Device {
  public:
    OnOff(byte _TodeIndex, byte _RFID, bool _NewDevice = false, bool _ReadOnly = false);
...
class AnaInput : public Device {
  public:
    AnaInput(byte _TodeIndex, byte _RFID, bool _NewDevice = false);
...
class Dist : public Device {
  public:
    Dist(byte _TodeIndex, byte _RFID, bool _NewDevice = false);
...
class STSTP3W : public Device {
  public:
    STSTP3W(byte _TodeIndex, byte _RFID, bool _NewDevice = false);
 ...
 * @brief   **DEVICE** Digital On/Off *Value* Control and Local Settings; inherits MenuValue.
 *********************************************************************************************************************/
class AnaOutput : public Device {
  public:
    AnaOutput(byte _TodeIndex, byte _RFID, bool _NewDevice = false);
  ...
  private:
            int     LastAnalogWriteValue=IVNOTSET;
    //HdwSelect*    Hardware = 0;
};
